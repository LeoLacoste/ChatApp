...
public class RegisterActivity extends AppCompatActivity {
    ...
    private void CreateNewAccount() {
        ...
        if(TextUtils.isEmpty(email)){
            Toast.makeText(this, "Entre ton mail stp...", Toast.LENGTH_SHORT).show();
        }
        if(TextUtils.isEmpty(password)){
            Toast.makeText(this, "Entre ton mot de passe stp...", Toast.LENGTH_SHORT).show();
        }
        else {
            loadingBar.setTitle("Créer un nouveau compte");
            loadingBar.setMessage("Attendez, le temps que nous créeons votre compte...");
